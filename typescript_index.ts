...
export class Client {
  ...
  async getUsers(params?: Record<string, string>): Promise<unknown> {
    return this.request<unknown>("GET", `/users`, undefined, params);
  }
  ...
  async getProducts(): Promise<unknown> {
    return this.request<unknown>("GET", `/products`);
  }
...
export class MockClient {
  ...
  /** Get all users (mock) */
  async getUsers(_params?: Record<string, string>): Promise<unknown> {
